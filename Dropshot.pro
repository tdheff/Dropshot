...
DropshotRootPath=/home/tommy/dev/Dropshot
...
include(DropshotSource.pri)
include(DropshotHeader.pri)
include(DropshotConfig.pri)
include(DropshotIncludes.pri)
include(DropshotDefines.pri)

Dropshot-Linux-Debug.commands = $$build Dropshot Linux Debug  -project="\"$$gameProjectFile\"" $$args
Dropshot-Linux-DebugGame.commands = $$build Dropshot Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Dropshot-Linux-Shipping.commands = $$build Dropshot Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Dropshot-Linux-Test.commands = $$build Dropshot Linux Test  -project="\"$$gameProjectFile\"" $$args
Dropshot.commands = $$build Dropshot Linux Development  -project="\"$$gameProjectFile\"" $$args

DropshotEditor-Linux-Debug.commands = $$build DropshotEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
DropshotEditor-Linux-DebugGame.commands = $$build DropshotEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
DropshotEditor-Linux-Shipping.commands = $$build DropshotEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
DropshotEditor-Linux-Test.commands = $$build DropshotEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
DropshotEditor.commands = $$build DropshotEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
